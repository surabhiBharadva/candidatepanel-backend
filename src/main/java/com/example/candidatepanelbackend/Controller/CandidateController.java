...
public class CandidateController {
	...
	private ResponseEntity<Candidate> saveCandidate(@RequestParam("candidate") String candidate,@RequestParam("file") MultipartFile file) throws JsonMappingException, JsonProcessingException {
		 Candidate candidateObject = mapper.readValue(candidate, Candidate.class);
		 Candidate candidateSave = candidateService.saveCandidate(candidateObject,file);
